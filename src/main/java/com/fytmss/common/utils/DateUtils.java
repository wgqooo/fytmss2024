...
public class DateUtils {
    ...
    public static String nextDay(String dateStr){
        ...
        return nextDay.toString(formatter);
    }
    ...
    public static String formatUTC(String strDate){
        // 解析日期时间字符串
        LocalDateTime dateTime = LocalDateTime.parse(strDate, java.time.format.DateTimeFormatter.ISO_DATE_TIME);
        // 转换为中国时区
